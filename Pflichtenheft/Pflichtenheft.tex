...
\item Ein Autor soll zu einer reviewbaren Frage, zu der noch keine Reviews angefordert wurden, Reviews anfragen können.
\item Wenn zu einer reviewbaren Frage Reviews angefordert werden, sollen automatisch eine oder mehrere Personen aus der Gruppe des zur reviewbaren Frage zugehörigen Autors per Nachricht informiert und aufgefordert werden, dass ihnen zugeordnete Review zu beantworten.
\item Die Auswahl von zu einer reviewbaren Frage zugehörigen Reviewern soll zufällig erfolgen.
\item Die Anzahl der zu einer reviewbaren Frage zugehörigen Reviewer soll einstellbar sein.
...
\item Ein Autor soll nach Bearbeitung einer reviewbaren Frage die Möglichkeit haben, die bereits der Frage zugehörigen Reviews zur erneuten Bearbeitung freizugeben. Die zugehörigen Reviewer sollen automatisch darüber informiert werden.
...
\item Die Eingabe-Benutzeroberfläche steht nur Personen bereit, die ausgewählt wurden, um ein Review zu beantworten.
...
\item Die Ausgabe-Benutzeroberfläche soll nur dem Autor der zum Review zugehörigen Frage und einem Administrator bereit stehen.
\item Der Autor der zum Review zugehörigen Frage soll keine Namen von Personen sehen, die ausgewählt wurden, um die Reviews zu beantworten.
\item Der Administrator soll die Namen von Personen sehen, die ausgewählt wurden, um die Reviews zu beantworten.
...
\item Das Plugin nutzt die in ILIAS vorhandene Plugin-Schnittstelle.
\end{enumerate}
